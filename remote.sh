...
run_command() {
  ...
  then
    ...
    scp ec2-user@flink1:$BASE_DIR/data/flink-1.11.2/log/flink-ec2-user-standalonesession-0-multilevel-benchmark-5.novalocal.log ec2-user@zk1:$BASE_DIR/data/jm.log
