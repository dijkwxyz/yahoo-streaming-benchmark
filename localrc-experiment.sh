...
#MTTI_MS=${MTTI_MS:-40000}
MTTI_MS=-1
CHECKPOINT_INTERVAL_MS=${CHECKPOINT_INTERVAL_MS:-30000}
#CHECKPOINT_INTERVAL_MS=${CHECKPOINT_INTERVAL_MS:-90000}
CHECKPOINT_MIN_PAUSE=60000
INJECT_WITH_PROBABILITY=true
#let "FAILURE_START_DELAY_MS=0"
#let "FAILURE_START_DELAY_MS=415000"
let "FAILURE_START_DELAY_MS=465000"
...
#1024*1024 = 1048576
#NET_THRESHOLD=${NET_THRESHOLD:-524288}
#NET_THRESHOLD=${NET_THRESHOLD:-349525}
...
#    for (( MTTI_MS=125000; MTTI_MS<= 365000; MTTI_MS+= 60 )); do
    for (( FLINK_PARALLELISM=28; FLINK_PARALLELISM <= 28; FLINK_PARALLELISM += 24 )); do
	./clear-data.sh
